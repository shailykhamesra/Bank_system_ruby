...
RSpec.describe Account, type: :model do
  context 'success validation and association test' do
    ...
    it 'should have many loans' do
      ...
      loan1.account.id.should(eq account.id) && loan2.account.id.should(eq account.id) && loan3.account.id.should(eq account.id)
    end
    it 'should have many lockers' do
      ...
      locker1.account.id.should(eq account.id) && locker2.account.id.should(eq account.id) && locker3.account.id.should(eq account.id)
    end
    it 'should have many transactions' do
      ...
      transaction1.account.id.should(eq account.id) && transaction2.account.id.should(eq account.id) && transaction3.account.id.should(eq account.id)
    end
